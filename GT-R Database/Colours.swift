...
class ColourManager: NSObject {
    ...
    let colours: [CarColour] = [
        ...
        CarColour(code: "AR2", name: "Active Red", colour: #colorLiteral(red: 0.7122970223, green: 0.0909647271, blue: 0.09065987915, alpha: 1), lightTextRequired: true),
        ...
        CarColour(code: "AN0", name: "Super Clear Red", colour: #colorLiteral(red: 0.4365019798, green: 0.2039727271, blue: 0.2366291285, alpha: 1), lightTextRequired: true),
        CarColour(code: "AR1", name: "Super Clear red II", colour: #colorLiteral(red: 0.4475283623, green: 0.05518782884, blue: 0.1158859655, alpha: 1), lightTextRequired: true),
        CarColour(code: "BN6", name: "Deep Marine Blue", colour: #colorLiteral(red: 0.1023396328, green: 0.1096676663, blue: 0.1829155385, alpha: 1), lightTextRequired: true),
        CarColour(code: "BT2", name: "Chamption Blue", colour: #colorLiteral(red: 0.0871996358, green: 0.2933940589, blue: 0.5894206762, alpha: 1), lightTextRequired: true),
        ...
        CarColour(code: "KH2", name: "Gun Grey Metallic", colour: #colorLiteral(red: 0.231338948, green: 0.2313939631, blue: 0.2231310904, alpha: 1), lightTextRequired: true),
        CarColour(code: "KH3", name: "Black", colour: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), lightTextRequired: true),
        ...
        CarColour(code: "KN6", name: "Dark Grey Pearl", colour: #colorLiteral(red: 0.1723573506, green: 0.1607885957, blue: 0.1648578942, alpha: 1), lightTextRequired: true),
        CarColour(code: "LP2", name: "Midnight Purple", colour: #colorLiteral(red: 0.2145657539, green: 0.1175275669, blue: 0.1988671124, alpha: 1), lightTextRequired: true),
        ...
        CarColour(code: "732", name: "Black Pearl Metallic", colour: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), lightTextRequired: true),
        ...
        CarColour(code: "AH3", name: "Red Pearl Metallic", colour: #colorLiteral(red: 0.5020172596, green: 0.06323806196, blue: 0.05073405057, alpha: 1), lightTextRequired: true),
        ...
        CarColour(code: "TH1", name: "Dark Blue Pearl", colour: #colorLiteral(red: 0.09935035557, green: 0.1330476999, blue: 0.2629569471, alpha: 1), lightTextRequired: true)
    ]
